...
bodyEx.innerHTML = `<body class="body"><header class="header"></header><main class="main"><section class="playground"><section class="table"></section><section class="playground__interection interection"><section class="interection__editor editor"></section><section class="interection__viewer viewer"></section></section></section><aside class="level"></aside></main><footer class="footer"></footer></body>`;
